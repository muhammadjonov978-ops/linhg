...
const AI_RESPONSES = {
  ...
  practice: {
    uzbek: (lang: string) => `Ajoyib! Keling ${lang} tilida suhbatlashamiz. Sizga qanday mavzu bo'yicha mashq qilish qiziq?`,
    english: (lang: string) => `Great! Let's practice ${lang}. What topic would you like to discuss?`,
  },
};

function generateAIResponse(userMessage: string, lang?: { id: string; name: string; flag: string }): AIResponse {
      ...
      <div className="bg-base-100 rounded-2xl shadow-2xl border border-base-300 overflow-hidden">
        <div className="bg-gradient-to-r from-primary to-secondary p-4 text-white flex items-center justify-between">
          ...
          <div className="flex gap-1">
            <button
              onClick={() => speakText("Hello! I'm your AI tutor. Ask me anything about the language!", 'greeting')}
        ...
        <div className="h-96 overflow-y-auto p-4 space-y-3 bg-gradient-to-b from-base-200/50 chat-scroll">
